...
namespace GSN.Modules.DigitalAssetUpload.Components
{
    public abstract class DigitalAssetUploadModuleBase : PortalModuleBase
    {
        ...
        protected DigitalAssetUploadModuleBase()
        {
            Load += Page_Load;
        }

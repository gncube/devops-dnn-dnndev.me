...
namespace GSN.Modules.Conference.Controllers
{
    ...
    public class SettingsController : DnnController
    {
        ...
        public ActionResult Settings()
        {
            ...
            settings.Setting1 = ModuleContext.Configuration.ModuleSettings.GetValueOrDefault("GSN.Modules.Conference_Setting1", false);
            settings.Setting2 = ModuleContext.Configuration.ModuleSettings.GetValueOrDefault("GSN.Modules.Conference_Setting2", System.DateTime.Now);
